...
class StockDataset(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            ...
            a = torch.FloatTensor(self.data[ii][:, t0:t0 + cfg.max_seq_len * cfg.history_multiplier])
            b = torch.zeros(2, cfg.max_seq_len * cfg.history_multiplier)
            ...
            tools.pyout(f"Exception @ ({ii}, {t0}). Finding alternative...")
    ...
    def _index_stocks(self):
        ...
        for ii, symbol in enumerate(tqdm(listdir("./res/in/stocks"),
            ...
            try:
                ...
                if df.shape[1] <= 200 + cfg.max_seq_len * (cfg.history_multiplier + 1):
                    continue
                if self.mode == 'train':
